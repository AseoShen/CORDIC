...
`define AESL_DEPTH_sine 1
`define AESL_DEPTH_cosine 1
`define AUTOTB_TVIN_theta  "./c.cordic.autotvin_theta.dat"
`define AUTOTB_TVIN_theta_out_wrapc  "./rtl.cordic.autotvin_theta.dat"
`define AUTOTB_TVOUT_sine  "./c.cordic.autotvout_sine.dat"
`define AUTOTB_TVOUT_cosine  "./c.cordic.autotvout_cosine.dat"
`define AUTOTB_TVOUT_sine_out_wrapc  "./impl_rtl.cordic.autotvout_sine.dat"
`define AUTOTB_TVOUT_cosine_out_wrapc  "./impl_rtl.cordic.autotvout_cosine.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 90;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 13;
parameter LENGTH_theta = 1;
parameter LENGTH_sine = 1;
parameter LENGTH_cosine = 1;
...
reg end_sine;
reg [31:0] size_sine;
reg [31:0] size_sine_backup;
reg end_cosine;
reg [31:0] size_cosine;
reg [31:0] size_cosine_backup;
...
reg dump_tvout_finish_sine;

initial begin : dump_tvout_runtime_sign_sine
    integer fp;
    dump_tvout_finish_sine = 0;
    fp = $fopen(`AUTOTB_TVOUT_sine_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_sine_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_sine_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_sine_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    ...
    $fdisplay(fp,"[[[/runtime]]]");
    $fclose(fp);
    dump_tvout_finish_sine = 1;
end


reg dump_tvout_finish_cosine;

initial begin : dump_tvout_runtime_sign_cosine
    integer fp;
    dump_tvout_finish_cosine = 0;
    fp = $fopen(`AUTOTB_TVOUT_cosine_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_cosine_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_cosine_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_cosine_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;

...
set xo_kernel_name "cordic"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/VitisHLSProjects/cordic_hls/solution1"
set debug_dir "D:/VitisHLSProjects/cordic_hls/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {cordic_control_s_axi
cordic
}
set kernel_xo ""
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 theta W 0x0 "Data signal of theta" {{0 28 theta W 0 "Bit 27 to 0 of theta"} {28 4 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 sine R 0x0 "Data signal of sine" {{0 28 sine R 0 "Bit 27 to 0 of sine"} {28 4 RESERVED R 0 "Reserved.  0s on read."}}} {0x1c sine_ctrl R 0x0 "Control signal of sine" {{0 1 sine_ap_vld R 0 "Control signal sine_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 cosine R 0x0 "Data signal of cosine" {{0 28 cosine R 0 "Bit 27 to 0 of cosine"} {28 4 RESERVED R 0 "Reserved.  0s on read."}}} {0x2c cosine_ctrl R 0x0 "Control signal of cosine" {{0 1 cosine_ap_vld R 0 "Control signal cosine_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 13 II x}
...
source -notrace "D:/Xilinx/Vitis_HLS/2020.2/common/scripts/ipxhls.tcl"

; ModuleID = 'D:/VitisHLSProjects/cordic_hls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_cordic_ir(%struct.ap_fixed* nocapture readonly %theta, %struct.ap_fixed* %sine, %struct.ap_fixed* %cosine) local_unnamed_addr #0 {
entry:
  %sine_copy1 = alloca %struct.ap_fixed, align 512
  %cosine_copy2 = alloca %struct.ap_fixed, align 512
  call fastcc void @copy_in(%struct.ap_fixed* %sine, %struct.ap_fixed* nonnull align 512 %sine_copy1, %struct.ap_fixed* %cosine, %struct.ap_fixed* nonnull align 512 %cosine_copy2)
  call void @apatb_cordic_hw(%struct.ap_fixed* %theta, %struct.ap_fixed* %sine_copy1, %struct.ap_fixed* %cosine_copy2)
  call fastcc void @copy_out(%struct.ap_fixed* %sine, %struct.ap_fixed* nonnull align 512 %sine_copy1, %struct.ap_fixed* %cosine, %struct.ap_fixed* nonnull align 512 %cosine_copy2)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%struct.ap_fixed*, %struct.ap_fixed* noalias align 512, %struct.ap_fixed*, %struct.ap_fixed* noalias align 512) unnamed_addr #1 {
entry:
...
declare void @apatb_cordic_hw(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*)

define void @cordic_hw_stub_wrapper(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*) #6 {
entry:
  call void @copy_out(%struct.ap_fixed* null, %struct.ap_fixed* %1, %struct.ap_fixed* null, %struct.ap_fixed* %2)
  call void @cordic_hw_stub(%struct.ap_fixed* %0, %struct.ap_fixed* %1, %struct.ap_fixed* %2)
  call void @copy_in(%struct.ap_fixed* null, %struct.ap_fixed* %1, %struct.ap_fixed* null, %struct.ap_fixed* %2)
  ret void
}

declare void @cordic_hw_stub(%struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*)
